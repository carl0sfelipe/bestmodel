...
| `dependencies/auth_provider.py` | `WebAuthnConfig` (env `AUTH_RP_ID`, `AUTH_RP_NAME`, `AUTH_EXPECTED_ORIGIN`), `get_current_user` bearer resolver (401 on missing/revoked/expired) |
