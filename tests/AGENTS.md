...
| `test_music_intent.py` | music nested under audio: classification, CHECK, fixture vs Whisper |
| `fixtures/music_audio_intent.json` | labeled stub cells (not measured) — MusicGen `music` vs Whisper `audio` |
