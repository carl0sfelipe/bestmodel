...
- Phase 1 (in progress): **S13–S16 DONE** (auth; rigs/profiles; claims+voting;
  settle flow claim→signed run→settled_verified with reputation credit).
  Next: S17 follows/feed.
